...
<?php echo form_open('logradouros/cadastrar');?>
<table>
    <tr>
        <td><strong><?php echo form_label('Tipo', 'logradourotipo_id')?></strong></td>
        <td><input type="text" name="logradourotipo_nome" placeholder="ESCOLHER TIPO" size="20" class="escolher-tipos"><?php echo form_error('logradourotipo_id'); ?></td>
    </tr>
    <tr>
        <td><strong><?php echo form_label('Logradouro', 'nome')?></strong></td>
        <td><?php echo form_input(array('name'=>'nome','id'=>'nome','size'=>'40'),set_value('nome'));?><?php echo form_error('nome'); ?></td>
    </tr>
    <tr>
        <td><strong><?php echo form_label('Bairro', 'bairro_id')?></strong></td>
        <td><input type="text" name="bairro_nome" placeholder="ESCOLHER BAIRRO" size="30" class="escolher-bairros"><?php echo form_error('bairro_id'); ?></td>
    </tr>
    <tr>
        <td><strong><?php echo form_label('Subunidade', 'subunidade_id')?></strong></td>
        <td><input type="text" name="subunidadeo_nome" placeholder="ESCOLHER SUBUNIDADE" size="30" class="escolher-subunidades"><?php echo form_error('subunidade_id'); ?></td>
    </tr>
    <tr>
...
<input type="hidden" name="logradourotipo_id" id="logradourotipo_id" />
...
<input type="hidden" name="subunidade_id" id="subunidade_id" />
...
/* Location: ./application/views/desktop/logradouros/cadastrar.php */
