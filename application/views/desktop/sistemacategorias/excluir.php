...
<?php echo form_open('sistemacategorias/excluir'); ?>
<table>
    <tr>
    ...
    <tr>
        ...
        <td><?php echo $categoria->sistemamodulo->nome;?></td>
    </tr>
    <tr>
...
<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>A categoria será permanentemente excluído da base de dados. Você tem certeza disso?</p>
</div>
...
/* Location: ./application/views/desktop/sistemacategorias/excluir.php */
