...
<?php echo form_open('acaotipos/excluir'); ?>
<table>
    <tr>
        <td><strong>Categoria</strong></td>
        <td><?php echo $tipo->acaocategoria->nome;?></td>
    </tr>
    <tr>
...
<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>O tipo de ação policial será permanentemente excluído da base de dados. Você tem certeza disso?</p>
</div>
