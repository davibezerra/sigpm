...
<?php echo form_open('estados/excluir'); ?>
<table>
    <tr>
...
<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>O estado será permanentemente excluído da base de dados. Você tem certeza disso?</p>
</div>

<?php echo form_hidden('id', $uf->id);?>  
<?php echo form_hidden('sigla', $uf->sigla);?>  
           
<?php echo form_close();


/* End of file excluir.php */
/* Location: ./application/views/desktop/estados/excluir.php */
