...
<?php echo form_open('ocorrenciatipos/cadastrar');?>
<table>
    <tr>
...
<input type="hidden" name="ocorrenciacategoria_id" id="ocorrenciacategoria_id" />
...
/* Location: ./application/views/desktop/ocorrenciatipos/cadastrar.php */
