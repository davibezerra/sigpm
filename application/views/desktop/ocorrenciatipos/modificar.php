<script type="text/javascript" src="js/apply/jquery.modal.ocorrenciacategorias.js" ></script>

<?php echo form_open('ocorrenciatipos/modificar/'.$tipo->id);?>
<table>
    <tr>
        <td><strong><?php echo form_label('Categoria', 'ocorrenciacategoria_id')?></strong></td>
        <td><input type="text" name="categoria_nome" placeholder="ESCOLHER CATEGORIA" size="30" class="escolher-categorias" value="<?php echo $tipo->ocorrenciacategoria->nome; ?>"><?php echo form_error('ocorrenciacategoria_id'); ?></td>
    </tr>
    <tr>
...
<input type="hidden" name="ocorrenciacategoria_id" id="ocorrenciacategoria_id" value="<?php echo $tipo->ocorrenciacategoria_id;?>" />
...
/* Location: ./application/views/desktop/ocorrenciatipos/modificar.php */
