			...
			if (data) {
				...
				$.each(data, function(index, value) {
					...
					if ($.isPlainObject(value)) {
						str.push('<li ' + vclass + ' data-icon=' + settings.icon + '><a href="' + settings.link + encodeURIComponent(value.id) + '" data-transition="' + settings.transition + '" data-autocomplete=\'' + JSON.stringify(value).replace(/'/g, "&#39;") + '\'>' + settings.labelHTML(value.nome) + '</a></li>');
					} else {
